...
const PublicPropertySheet: React.FC<PublicPropertySheetProps> = ({ property }) => {
    ...
    return (
        <>
            ...
            <div className="relative flex min-h-screen w-full flex-col max-w-[430px] mx-auto bg-[#0d141b] shadow-2xl overflow-x-hidden font-sans pb-10">
                ...
                {/* Location Bar */}
                <div className="relative -mt-6 mx-4 mb-6 flex items-center gap-4 bg-white px-5 py-5 rounded-2xl shadow-xl border border-slate-100">
                    ...
                    <div className="flex flex-col flex-1 min-w-0">
                        <p className="text-[#0d141b] text-sm font-bold truncate tracking-tight">{property.address}, {property.number}</p>
                        <p className="text-slate-500 text-xs truncate mt-0.5">{property.neighborhood}, {property.city} - {property.state}</p>
                    </div>
                    <div className="shrink-0">
                        <button
                            className="p-2 text-slate-300 hover:text-[#A64614] transition-colors"
                            title="Ver no Mapa"
                        >
                ...
                <div className="px-5 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <DetailCard
                            icon={<FileText size={18} />}
                            label="Matrícula"
                            value={property.registration || 'N/A'}
                        />
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-6 gap-2 h-[280px]">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/20">
                                <span className="text-white border border-white/50 rounded-full p-3 backdrop-blur-sm">
                                    <Maximize2 size={20} />
                                </span>
                            </div>
                        </div>
                ...
                {/* IPTU Info Section */}
                <div className="px-5 mb-8">
                    <div className="bg-slate-800 text-white p-6 rounded-3xl shadow-xl flex items-center justify-between overflow-hidden relative group">
...
const DetailCard: React.FC<DetailCardProps> = ({ icon, label, value }) => (
    <div className="bg-slate-800/50 p-3.5 rounded-2xl border border-slate-700 shadow-sm hover:shadow-md transition-shadow">
