    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 mb-8 space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl">
                    <button
                        ...
                        className={`p-2 rounded-lg transition-all flex items-center gap-2 text-sm font-semibold ${viewMode === 'cards' ? 'bg-white shadow-sm text-blue-600' : 'text-slate-500 hover:text-slate-700'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-2 rounded-lg transition-all flex items-center gap-2 text-sm font-semibold ${viewMode === 'list' ? 'bg-white shadow-sm text-blue-600' : 'text-slate-500 hover:text-slate-700'
                            }`}
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 pt-4 border-t border-slate-100">
                ...
                <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">Situação</label>
                    <div className="relative">
