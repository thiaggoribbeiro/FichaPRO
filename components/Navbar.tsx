...
interface NavbarProps {
  user?: User | null;
  currentView: string;
  onViewChange: (view: 'dashboard' | 'properties' | 'leads' | 'settings' | 'negotiation') => void;
}
        ...
        <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-400 font-medium">v1.4.0</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className={`text-sm font-semibold transition-colors ${currentView === 'leads' ? 'text-[#A64614]' : 'text-slate-600 hover:text-[#A64614]'}`}
            >
              Leads
            </button>
            <button
